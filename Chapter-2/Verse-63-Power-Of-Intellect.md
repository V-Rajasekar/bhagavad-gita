...
```
 ...
 `delusion` means when ever you away from reality or facts that stage is called delusion.
...
It's the level of understanding important morethan repeating the things you learned. 
`story` 
```language
